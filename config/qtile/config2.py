...
Key([], "XF86AudioRaiseVolume",
    lazy.spawn("wpctl set-volume @DEFAULT_AUDIO_SINK@ 5%+ && notify-send 'Volume Up'"),
    desc="Volume up"),

Key([], "XF86AudioLowerVolume",
    lazy.spawn("wpctl set-volume @DEFAULT_AUDIO_SINK@ 5%- && notify-send 'Volume Down'"),
    desc="Volume down"),

Key([], "XF86AudioMute",
    lazy.spawn("wpctl set-mute @DEFAULT_AUDIO_SINK@ toggle && notify-send 'Mute'"),
    desc="Mute volume"),

   # Brightness controls

Key([], "XF86MonBrightnessUp",
    lazy.spawn("brightnessctl set +10% && notify-send 'Brightness Up'"),
    desc="Increase brightness"),

Key([], "XF86MonBrightnessDown",
    lazy.spawn("brightnessctl set 10%- && notify-send 'Brightness Down'"),
